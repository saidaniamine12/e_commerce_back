...
public class UploadCoercing implements Coercing<MultipartFile, UploadScalar> {

    @Override
    public UploadScalar serialize(Object dataFetcherResult) throws CoercingSerializeException {
